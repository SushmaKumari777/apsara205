                ...
                <Container>
                    <Row>
                        ...
                        <Col md={4}>
                            ...
                            <Button variant="outline-secondary" className="button" onClick={handleShow} style={{marginTop:"20px",marginLeft:"10px", width:"100px",height:"40px"}}><Link to={'/Address'} ><p>Buy now</p></Link></Button>
